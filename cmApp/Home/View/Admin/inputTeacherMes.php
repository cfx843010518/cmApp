...
<div class="easyui-layout" style="width:1100px;height:400px;margin-left:100px;">
	...
	<div id="content" region="center" title="内容" style="padding:5px;">
		...
		<form action="exportTeaMes" method="post" enctype="multipart/form-data">
			<input type="file" name="file"/>
			<input type="submit" value="导入"/>
		</form>
		<br/><br/>
		<strong>2.多个Excel表的导入(请将Excel文件放在项目Public/upload3目录下,导入时间较长，需耐心等待)</strong>
		<a href="exprotManyTeaSub" onclick="return confirm('确定要导入数据，该操作只有在系统初始化的时候才能使用，重复导入数据会导致系统出错！')">多个文件导入</a>
		<br/><br/>
		</center>
	</div>
</div>
